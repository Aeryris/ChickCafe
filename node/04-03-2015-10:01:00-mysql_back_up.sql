...
INSERT INTO `backup` VALUES (208,0,'10:01:00',NULL);
...
INSERT INTO `customer` VALUES (3,'2015-03-21 18:35:14',0.00),(4,'2015-03-21 18:38:20',961.88);
...
INSERT INTO `customer_order` VALUES (7,1,19,NULL),(8,4,20,0),(9,4,21,NULL),(10,4,22,NULL),(11,4,23,NULL),(12,4,24,NULL),(13,4,33,NULL),(14,4,34,NULL),(15,4,35,NULL),(16,4,36,NULL),(17,4,37,NULL),(18,4,38,NULL),(19,4,39,NULL),(20,4,40,NULL),(21,4,41,NULL),(22,4,42,NULL),(23,4,43,NULL),(24,4,44,NULL),(25,4,45,NULL),(26,4,46,NULL),(27,4,47,NULL),(28,4,48,NULL),(29,4,49,NULL),(30,4,50,NULL),(31,4,51,NULL);
...
CREATE TABLE `daily_special` (
  `daily_special_id` int(10) NOT NULL AUTO_INCREMENT,
  `daily_special_date` date NOT NULL,
  `item_id` int(10) NOT NULL,
  `menu_id` int(10) NOT NULL,
  PRIMARY KEY (`daily_special_id`),
  KEY `fk_dailyspecial_item_id` (`item_id`),
  KEY `fk_dailyspecial_menu_id` (`menu_id`),
  CONSTRAINT `daily_special_ibfk_2` FOREIGN KEY (`menu_id`) REFERENCES `menu` (`menu_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `daily_special_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `item` (`item_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
LOCK TABLES `daily_special` WRITE;
/*!40000 ALTER TABLE `daily_special` DISABLE KEYS */;
INSERT INTO `daily_special` VALUES (1,'2015-04-07',1,1);
/*!40000 ALTER TABLE `daily_special` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ingredient` VALUES (1,'Onion',20,0,NULL,1),(2,'Chicken',15,21,NULL,0),(3,'New ingredient',10,10,NULL,0);
...
INSERT INTO `item` VALUES (1,'Oreo','Well this is the item description, we need something here as well',100,20,2.99,1,'heic1501a.jpg',0),(2,'Doritos','Well this is the item description, we need something here as well',100,1,2.99,1,'heic1501a.jpg',0),(3,'Pizza','Well this is the item description, we need something here as well',10,0,5.99,10,'heic1501a.jpg',1),(4,'Cesar Salad','Well this is the item description, we need something here as well',9,0,6.99,15,'heic1501a.jpg',1),(5,'Beef','Well this is the item description, we need something here as well',10,1,20.00,10,'heic1501a.jpg',0),(6,'Image','test',10,10,10.00,10,NULL,0),(7,'TEs','tts',10,10,10.00,10,NULL,0),(8,'e2e','wfw',10,10,10.00,10,NULL,0),(9,'e2e','wfw',10,10,10.00,10,NULL,0),(10,'e2e','wfw',10,10,10.00,10,NULL,0),(11,'e2e','wfw',10,10,10.00,10,NULL,0),(12,'dff','dhjh',10,10,10.00,10,NULL,0),(13,'dff','dhjh',10,10,10.00,10,NULL,0),(14,'Test image','Well this is the item description, we need something here as well',10,0,10.00,10,'heic1501a.jpg',1);
...
INSERT INTO `item_ingredients` VALUES (20,1,1,12),(22,2,2,1),(23,1,3,2),(24,1,5,4),(25,2,5,1),(26,2,1,2);
...
INSERT INTO `menu` VALUES (1,'Break Fast','This is delicious menu description, guys please come up with some text that we can put in here','2015-04-07 14:00:00','2015-04-15 14:52:00',0,'Coffee-and-Breakfast.png'),(2,'Lunch','','2015-03-21 00:00:00','2015-04-01 23:00:00',0,NULL),(3,'Dinner','','2015-03-21 00:00:00','2015-04-01 23:00:00',0,NULL),(4,'Drinks','','2015-03-21 00:00:00','2015-04-01 23:00:00',0,NULL),(5,'New','','2016-00-00 00:00:00','0000-00-00 00:00:00',NULL,NULL),(6,'New','This is delicious menu description, guys please come up with some text that we can put in here','2015-04-05 16:00:00','2015-04-30 17:00:00',NULL,'Coffee-and-Breakfast.png'),(7,'New menu','','2015-04-05 16:00:00','2015-04-05 18:00:00',NULL,NULL),(8,'New menu','This is delicious menu description, guys please come up with some text that we can put in here','2015-04-07 18:33:00','2015-04-11 18:53:00',NULL,'Coffee-and-Breakfast.png');
...
INSERT INTO `order_payment` VALUES (23,'B T KLISZCZYK','4600 0000 0000 0000','984','10 / 20'),(24,'B T KLISZCZYK','4600 0000 0000 0000','942','10 / 24'),(33,'fff','4600 0000 0000 0000','234','12 / 22'),(34,'B T KLISZCZYK','4600 0000 0000 0000','234','10 / 20'),(35,'B T KLISZCZYK','4600 0000 0000 0000','345','10 / 20'),(36,'B T KLISZCZYK','4660 0000 0000 0000','234','10 / 18'),(37,'B T KLISZCZYK','4600 0000 0000 0000','456','10 / 20'),(38,'B T KLISZCZYK','4600 0000 0000 0000','244','10 / 40'),(39,'B T KLISZCZYK','4600 0000 0000 0000','234','10 / 16'),(40,'B T KLISZCZYK','4600 0000 0000 0000','333','03 / 33'),(41,'B T KLISZCZYK','4600 0000 0000 0000','345','10 / 20'),(42,'B T KLISZCZYK','4600 0000 0000 0000','933','10 / 20'),(43,'B T KLISZCZYK','4600 0000 0000 0000','345','10 / 24'),(47,'B T KLISZCZYK','4600 0000 0000 000','465','10 / 20'),(51,'B T KLISZCZYK','4600 0000 0000 0000','475','10 / 20');
...
-- Dump completed on 2015-04-09 10:01:00
