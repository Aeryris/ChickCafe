    ...
    <div id="main" class="container clear-top">
        <div class="form-block center-block" style="max-width: 40%;">
            <form class="form-signin" method="post" action="/user/register">
                ...
                <input name="firstname" type="text" id="inputFirstname" class="form-control" placeholder="First Name" autofocus>
                ...
                <p>Already registered? <a id="login_link" href="/user/login">Click here to login.</a></p>
            </form>
            <div>
